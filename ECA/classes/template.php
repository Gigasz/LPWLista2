    ...
    function sidebar()
    {
        ...
        <div class=\"sidebar-wrapper\">
            ...
            <ul class=\"nav\">
                ...
                <li>
                    <a href='beneficiaries_peti.php'>
                        <i class=\"ti-user\"></i>
                        <p>Beneficiaries PETI</p>
                    </a>
                </li>
                <li>
                    <a href='beneficiaries_segurodefeso.php'>
                        <i class=\"ti-user\"></i>
                        <p>Beneficiaries Seguro Defeso</p>
                    </a>
                </li>
                <li>
                    <a href='beneficiaries_bolsafamilia.php'>
                        <i class=\"ti-user\"></i>
                        <p>Beneficiaries Bolsa Familia</p>
                    </a>
                </li>
                <li>
                    <a href='files.php'>
